...
class View {
    ...
    public function __construct() {
        if (isset($_COOKIE["lang"])) {
            $this->idioma = $_COOKIE["lang"];
        } else {
            $this->idioma = "ca";
        }
                
        $this->loged= (isset($_SESSION['loggedin']) && $_SESSION['loggedin']===true);
    }
    ...
    function html_generateSelect($opcions, $seleccionat, $atributs) {
        ...
        if (isset($atributs['span'])) {
            $resultat .= "<br><span class=\"error\" > {$atributs['span']} </span>\n";
        }
    ...
    function html_generaInput($options) {
        ...
        if (isset($options['span'])) {
            $resultat .= "<br><span class=\"error\" > {$options['span']} </span>\n";
        }
        return $resultat;
    }
